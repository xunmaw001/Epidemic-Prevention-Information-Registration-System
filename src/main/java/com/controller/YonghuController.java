...
public class YonghuController {
    ...
    */
    ...
    public R update(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if("".equals(yonghu.getShenfenzhengZPhoto()) || "null".equals(yonghu.getShenfenzhengZPhoto())){
                yonghu.setShenfenzhengZPhoto(null);
        }
        if("".equals(yonghu.getShenfenzhengFPhoto()) || "null".equals(yonghu.getShenfenzhengFPhoto())){
                yonghu.setShenfenzhengFPhoto(null);
        }
        if(yonghuEntity==null){
            //  String role = String.valueOf(request.getSession().getAttribute("role"));
            //  if("".equals(role)){
